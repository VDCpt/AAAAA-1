/* [ARTEFACTO INERTE] */
/* Nota de Clarificação F16 (2026-06-24): A propriedade modo: 'DEMO' definida abaixo
 * desativa integralmente o middleware de autenticação client-side (auth.js, bloco
 * AUTH-FIX-01). Este ficheiro não deve ser interpretado como configuração de um
 * controlo de acesso operante na distribuição DEMO. Esta nota não altera nenhuma
 * linha de lógica executável do ficheiro original.
 * Ver TERMO_ENCERRAMENTO_PERICIAL_F16.md, Secção 2 (Achado A8). */
