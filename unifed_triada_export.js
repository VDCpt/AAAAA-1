...
Fundamentação Legal: Art. 327.º CPP (Contraditório) · Art. 125.º CPP (Admissibilidade de Prova) · Art. 103.º/104.º RGIT (Fraude Fiscal/Qualificada) · Art. 36.º, n.º 11 CIVA · Decreto-Lei n.º 28/2019 (SAF-T/DAC7) · Diretiva (UE) 2021/514 (DAC7) · Termos e Condições da Plataforma · ISO/IEC 27037:2012 (prova digital)`, style: 'normal', margin: [0, 0, 0, 15] },
                ...
                { text: "CONSULTOR TÉCNICO INDEPENDENTE — NOTA DE SALVAGUARDA E RESPONSABILIDADE CIVIL\n\nIdentificação:\n* Nome: Técnico Forense\n* Cargo: Analista e Consultor Forense Independente | Big Data Analytics\n* Estatuto: Prestação de serviços de consultoria técnica especializada em ambiente extrajudicial e pré-contencioso (Regime de responsabilidade civil e contratual aplicável, ex vi Art. 798.º e seguintes do Código Civil).\n\nNOTA DE SALVAGUARDA JURÍDICA E ÂMBITO: As conclusões constantes neste documento infraestruturam-se exclusivamente nos artefactos e elementos documentais disponibilizados pelo solicitante. O presente parecer constitui uma análise técnica independente de natureza consultiva. Não assume a forma de perícia oficial nem de intervenção de consultor técnico de parte em processo penal já ordenado. O escopo material e analítico limita-se à integridade financeira e documental dos ativos digitais apresentados.\n\nDECLARAÇÃO DE COMPROMISSO: Declaro que o presente parecer técnico foi elaborado assumindo estritamente os deveres de independência, objetividade e imparcialidade profissional. Certifico que a metodologia aplicada (baseada em ISRS 4400 e boas práticas de Digital Forensics) é reprodutível e que os resultados aqui vertidos traduzem fielmente a decomposição de artefactos e a análise técnica realizada sobre o lote de dados estruturados fornecido.\n\nData: " + dataEmissao + "\n\nAssinatura do Técnico Responsável Pela Análise\n\n[ UNIFED - PROBATUM CERTIFIED - ANALISTA E CONSULTOR FORENSE - " + _unifedLiveVersion() + " ]\nEstudo de Viabilidade - Consultoria Forense Especializada - Uso restrito a mandato contratual autorizado\nFundamentação: Art. 798.º e ss. Código Civil (Responsabilidade Civil Contratual) - Regime de prestação de serviços extrajudicial", style: 'normal', margin: [0, 0, 0, 15] },
